...
class ZenodoBozenVisualizer:
    ...
    def create_sample_visualization(self, num_samples=4, save=True, show=True):
        ...
        if save:
            ...
            save_path = self.visualization_path / f'zenodo_bozen_samples_{timestamp}.png'
...
if __name__ == "__main__":
    ...
    visualizer = ZenodoBozenVisualizer(normalized_dataset_path, visualization_path)
